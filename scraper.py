...
def should_include_match(tour_name, team_a, team_b):
    ...
    whitelist_tournaments = [
        ...
        # Friendly & Preseason — ودية واستعراضية
        "ودية", "مباريات ودية", "مباراة ودية", "friendly", "friendlies",
        "استعراضية", "كأس أمم أفريقيا", "أمم أفريقيا",
        "كأس آسيا", "كأس أمريكا", "سوبر", "super cup", "supercup",
        "club world cup", "كأس عالم الأندية",
    ]
    ...
    whitelist_teams = [
        ...
        "إنتر ميلان", "انتر ميلان", "ميلان", "روما", "نابولي",
        "دورتموند", "أياكس", "بنفيكا", "بورتو", "أياكس",
    ]
