...
ALLOWED_TOURNAMENTS = [
    ...
    # Friendly matches — ودية ومباريات استعراضية
    "ودية", "مباريات ودية", "friendly", "friendlies",
    "استعراضية", "مباراة ودية", "كأس عالم الأندية",
    "دوري الدرجة الأولى", "دوري الدرجة الثانية",
    "كأس السوبر", "super cup", "supercup",
    "كأس الأمم", "كأس العرب", "كأس أفريقيا", "أمم أفريقيا",
    "كأس آسيا", "كأس أمريكا",
]
